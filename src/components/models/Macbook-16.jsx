...
Files: macbook-16.glb [639.28KB] > C:\Users\owenm\Desktop\macbook_gsap\public\models\macbook-16-transformed.glb [629.72KB] (1%)
...
export default function MacBookModel16(props) {
  ...
  useEffect(() => {
    scene.traverse((child) => {
      if (child.isMesh) {
        // change color if the part name is NOT no change parts
